...
void main()
{
    ...
    u_xlat0.w = u_xlat10_1 + _TextureSampleAdd.w;
...
void main()
{
    ...
    u_xlat0.xyz = u_xlat16_0.xyz + _TextureSampleAdd.xyz;
    u_xlat16_1 = texture(_AlphaTex, vs_TEXCOORD0.xy).x;
    u_xlat0.w = u_xlat16_1 + _TextureSampleAdd.w;
    u_xlat16_0 = u_xlat0 * vs_COLOR0;
    SV_Target0.xyz = u_xlat16_0.www * u_xlat16_0.xyz;
    SV_Target0.w = u_xlat16_0.w;
    return;
...
void main()
{
    ...
    u_xlat0.w = u_xlat16_0.x + _TextureSampleAdd.w;
    u_xlat16_1 = vs_COLOR0.w * u_xlat0.w + -0.00100000005;
    ...
    u_xlat0.xyz = u_xlat16_2.xyz + _TextureSampleAdd.xyz;
    u_xlat16_0 = u_xlat0 * vs_COLOR0;
    SV_Target0.xyz = u_xlat16_0.www * u_xlat16_0.xyz;
    SV_Target0.w = u_xlat16_0.w;
    return;
...
void main()
{
    ...
    u_xlat10_0.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat0.xyz = u_xlat10_0.xyz + _TextureSampleAdd.xyz;
    u_xlat10_2 = texture2D(_AlphaTex, vs_TEXCOORD0.xy).x;
    u_xlat0.w = u_xlat10_2 + _TextureSampleAdd.w;
    u_xlat16_0 = u_xlat0 * vs_COLOR0;
...
void main()
{
    ...
    u_xlat0.w = u_xlat16_2 + _TextureSampleAdd.w;
    u_xlat16_0 = u_xlat0 * vs_COLOR0;
    u_xlat16_1 = u_xlat16_1 * u_xlat16_0.w;
    SV_Target0.xyz = u_xlat16_0.xyz * vec3(u_xlat16_1);
    SV_Target0.w = u_xlat16_1;

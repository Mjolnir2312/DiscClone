...
//
///////////////////////////////////////////
Shader "Shader Graphs/TransparentGhost" {
Properties {
...
void main()
{
...
#ifdef UNITY_ADRENO_ES3
    u_xlatb0.x = !!(u_xlat8<0.0);
#else
    u_xlatb0.x = u_xlat8<0.0;
#endif
    if(u_xlatb0.x){discard;}
    u_xlat0.xyz = u_xlat16_2.xxx * vs_TEXCOORD3.xyz;
    ...
    u_xlat16_27 = dot(u_xlat16_2.xyz, u_xlat0.xyz);
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat0.x = u_xlat16_27 * 0.999938965;
    ...
    u_xlat8 = u_xlat8 * -0.999938965 + 1.00001001;
    u_xlat8 = u_xlat8 * u_xlat8;
    u_xlat0.x = u_xlat0.x * u_xlat8;
    u_xlat0.x = u_xlat0.x * 2.03125;
    u_xlat0.x = 6.10351562e-05 / u_xlat0.x;
    u_xlat16_26 = u_xlat0.x + -6.10351562e-05;
    ...
    SV_TARGET0.xyz = u_xlat16_2.xyz + _ObstacleColor.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat16_2.x = inversesqrt(u_xlat16_2.x);
    u_xlat16_2.xyz = u_xlat16_2.xxx * vs_TEXCOORD1.xyz;
    u_xlat16_17 = dot((-u_xlat0.xyz), u_xlat16_2.xyz);
    u_xlat16_17 = u_xlat16_17 + u_xlat16_17;
    u_xlat16_3.xyz = u_xlat16_2.xyz * (-vec3(u_xlat16_17)) + (-u_xlat0.xyz);
    ...
    u_xlat0.x = u_xlat16_17 * 0.999938965;
    ...
    u_xlat0.xyz = u_xlat1.xyz * vec3(u_xlat16_17);
    ...
    u_xlat5 = u_xlat5 * -0.999938965 + 1.00001001;

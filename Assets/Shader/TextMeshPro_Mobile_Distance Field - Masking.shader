...
void main()
{
    ...
    u_xlat4.xyz = vs_COLOR0.xyz * vec3(u_xlat16_1) + (-u_xlat16_2.xyz);
    u_xlat4.xyz = vec3(u_xlat0) * u_xlat4.xyz + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat16_1 = u_xlat16_4 * vs_TEXCOORD1.x + (-vs_TEXCOORD1.w);
#ifdef UNITY_ADRENO_ES3

...
SubProgram "gles " {
Local Keywords { "_FLIPBOOKBLENDING_ON" }
"#ifdef VERTEX
#version 100
...
void main()
{
    u_xlat10_0 = texture2D(_BaseMap, vs_TEXCOORD5.xy);
    u_xlat10_1 = texture2D(_BaseMap, vs_TEXCOORD0.xy);
    u_xlat0 = u_xlat10_0 + (-u_xlat10_1);
    u_xlat0 = vs_TEXCOORD5.zzzz * u_xlat0 + u_xlat10_1;
...
void main()
{
    u_xlat16_0 = texture(_BaseMap, vs_TEXCOORD5.xy);
    u_xlat16_1 = texture(_BaseMap, vs_TEXCOORD0.xy);
    u_xlat0 = u_xlat16_0 + (-u_xlat16_1);
    u_xlat0 = vs_TEXCOORD5.zzzz * u_xlat0 + u_xlat16_1;
    u_xlat16_0 = u_xlat0 * _BaseColor;
    u_xlat0 = u_xlat16_0 * vs_COLOR0;
#ifdef UNITY_ADRENO_ES3
    u_xlatb1 = !!(_Surface==1.0);
...
SubProgram "gles " {
Local Keywords { "_EMISSION" "_FLIPBOOKBLENDING_ON" }
"#ifdef VERTEX
#version 100
...
SubProgram "gles " {
Local Keywords { "_COLOROVERLAY_ON" }
"#ifdef VERTEX
#version 100
...
SubProgram "gles " {
Local Keywords { "_COLOROVERLAY_ON" "_FLIPBOOKBLENDING_ON" }
"#ifdef VERTEX
#version 100
...
void main()
{
    ...
    u_xlat0 = u_xlat10_0 + (-u_xlat10_1);
    u_xlat0 = vs_TEXCOORD5.zzzz * u_xlat0 + u_xlat10_1;
    u_xlat1.xyz = (-u_xlat0.xyz) * _BaseColor.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat16_0 = u_xlat0 * _BaseColor;
    u_xlat1.xyz = u_xlat1.xyz + u_xlat1.xyz;
    u_xlat2.xyz = (-vs_COLOR0.xyz) + vec3(1.0, 1.0, 1.0);
    u_xlat1.xyz = (-u_xlat1.xyz) * u_xlat2.xyz + vec3(1.0, 1.0, 1.0);
...
SubProgram "gles " {
Local Keywords { "_COLOROVERLAY_ON" "_EMISSION" "_FLIPBOOKBLENDING_ON" }
"#ifdef VERTEX
#version 100
...
;
    u_xlat1.xyz = u_xlat3.xyz * u_xlat2.xyz + u_xlat1.xyz;
    u_xlat10_2.xyz = texture2D(_EmissionMap, vs_TEXCOORD5.xy).xyz;
    u_xlat10_3.xyz = texture2D(_EmissionMap, vs_TEXCOORD0.xy).xyz;
    u_xlat2.xyz = u_xlat10_2.xyz + (-u_xlat10_3.xyz);
    u_xlat2.xyz = vs_TEXCOORD5.zzz * u_xlat2.xyz + u_xlat10_3.xyz;
    SV_Target0.xyz = u_xlat2.xyz * _EmissionColor.xyz + u_xlat1.xyz;
    u_xlatb1 = _Surface==1.0;
    SV_Target0.w = (u_xlatb1) ? u_xlat13 : 1.0;
    return;
}
...
;
    u_xlat1.xyz = u_xlat3.xyz * u_xlat2.xyz + u_xlat1.xyz;
    u_xlat16_2.xyz = texture(_EmissionMap, vs_TEXCOORD5.xy).xyz;
    u_xlat16_3.xyz = texture(_EmissionMap, vs_TEXCOORD0.xy).xyz;
    u_xlat2.xyz = u_xlat16_2.xyz + (-u_xlat16_3.xyz);
    u_xlat2.xyz = vs_TEXCOORD5.zzz * u_xlat2.xyz + u_xlat16_3.xyz;
    SV_Target0.xyz = u_xlat2.xyz * _EmissionColor.xyz + u_xlat1.xyz;
#ifdef UNITY_ADRENO_ES3
    u_xlatb1 = !!(_Surface==1.0);
#else
...
void main()
{
    ...
    u_xlat10_0 = texture2D(_BaseMap, vs_TEXCOORD0.xy);
    u_xlat16_2 = u_xlat10_0 * _BaseColor;
    u_xlatb3 = u_xlat16_2.y>=u_xlat16_2.z;
    u_xlat16_13 = (u_xlatb3) ? 1.0 : 0.0;
    u_xlat16_6 = u_xlat10_0.y * _BaseColor.y + (-u_xlat16_2.z);
    ...
    u_xlat16_6 = u_xlat10_0.x * _BaseColor.x + (-u_xlat16_13);
...
SubProgram "gles " {
Local Keywords { "_COLORCOLOR_ON" "_EMISSION" }
"#ifdef VERTEX
#version 100
...
void main()
{
    ...
    u_xlat16_6 = u_xlat10_0.x * _BaseColor.x + (-u_xlat16_13);
    u_xlat16_13 = u_xlat16_2.x * u_xlat16_6 + u_xlat16_13;
    u_xlat10_3.xzw = texture2D(_EmissionMap, vs_TEXCOORD0.xy).xyz;
    u_xlat16_2.xyz = u_xlat10_3.xzw * _EmissionColor.xyz;
    SV_Target0.xyz = vec3(u_xlat16_13) * u_xlat16_1.xyz + u_xlat16_2.xyz;
    u_xlatb3 = _Surface==1.0;
    SV_Target0.w = (u_xlatb3) ? u_xlat7 : 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_6 = u_xlat16_0.x * _BaseColor.x + (-u_xlat16_13);
    u_xlat16_13 = u_xlat16_2.x * u_xlat16_6 + u_xlat16_13;
    u_xlat16_3.xzw = texture(_EmissionMap, vs_TEXCOORD0.xy).xyz;
    u_xlat16_2.xyz = u_xlat16_3.xzw * _EmissionColor.xyz;
    SV_Target0.xyz = vec3(u_xlat16_13) * u_xlat16_1.xyz + u_xlat16_2.xyz;
#ifdef UNITY_ADRENO_ES3
    u_xlatb3 = !!(_Surface==1.0);
#else
...
SubProgram "gles " {
Local Keywords { "_ALPHATEST_ON" "_COLORCOLOR_ON" }
"#ifdef VERTEX
#version 100
...
void main()
{
    ...
    u_xlat16_2.x = u_xlat16_1.w * vs_COLOR0.w + (-_Cutoff);
    u_xlatb8 = u_xlat16_2.x<0.0;
    if(u_xlatb8){discard;}
    u_xlat16_2.x = u_xlat10_0.y * _BaseColor.y + (-u_xlat16_1.z);
    u_xlatb4 = u_xlat16_1.y>=u_xlat16_1.z;
    u_xlat16_5.x = (u_xlatb4) ? 1.0 : 0.0;
    u_xlat16_5.x = u_xlat16_5.x * u_xlat16_2.x + u_xlat16_1.z;
    u_xlatb4 = u_xlat16_1.x>=u_xlat16_5.x;
    u_xlat8 = u_xlat16_1.w * vs_COLOR0.w;
    u_xlat16_1.x = (u_xlatb4) ? 1.0 : 0.0;
    u_xlat16_9 = u_xlat10_0.x * _BaseColor.x + (-u_xlat16_5.x);
    u_xlat16_1.x = u_xlat16_1.x * u_xlat16_9 + u_xlat16_5.x;
    u_xlatb0 = vs_COLOR0.y>=vs_COLOR0.z;
    u_xlat16_2.xy = vs_COLOR0.yz;
    u_xlat16_2.z = float(0.0);
    u_xlat16_2.w = float(-0.333333343);
    u_xlat16_3.xy = vs_COLOR0.zy;
    u_xlat16_3.z = float(-1.0);
    u_xlat16_3.w = float(0.666666687);
    u_xlat16_2 = u_xlat16_2 + (-u_xlat16_3);
    u_xlat16_2 = (bool(u_xlatb0)) ? u_xlat16_2 : vec4(0.0, 0.0, 0.0, -0.0);
    u_xlat16_2 = u_xlat16_2.xywz + u_xlat16_3.xywz;
    u_xlat16_3.z = u_xlat16_2.w;
    u_xlatb0 = vs_COLOR0.x>=u_xlat16_2.x;
    u_xlat16_2.w = vs_COLOR0.x;
    u_xlat16_3.xyw = u_xlat16_2.wyx;
    u_xlat16_3 = (-u_xlat16_2) + u_xlat16_3;
    u_xlat16_3 = (bool(u_xlatb0)) ? u_xlat16_3 : vec4(0.0, 0.0, 0.0, 0.0);
    u_xlat16_2 = u_xlat16_2 + u_xlat16_3;
    u_xlat16_5.x = min(u_xlat16_2.y, u_xlat16_2.w);
    u_xlat16_5.x = (-u_xlat16_5.x) + u_xlat16_2.x;
    u_xlat16_9 = u_xlat16_5.x * 6.0 + 9.99999975e-05;
    u_xlat16_13 = (-u_xlat16_2.y) + u_xlat16_2.w;
    u_xlat16_9 = u_xlat16_13 / u_xlat16_9;
    u_xlat16_9 = u_xlat16_9 + u_xlat16_2.z;
    u_xlat16_13 = u_xlat16_2.x + 9.99999975e-05;
    u_xlat16_5.x = u_xlat16_5.x / u_xlat16_13;
    u_xlat16_2.xyz = abs(vec3(u_xlat16_9)) + vec3(1.0, 0.666666687, 0.333333343);
    ...
    u_xlat16_5.xyz = u_xlat16_5.xxx * u_xlat16_2.xyz + vec3(1.0, 1.0, 1.0);
    SV_Target0.xyz = u_xlat16_5.xyz * u_xlat16_1.xxx;
    u_xlatb0 = _Surface==1.0;
    SV_Target0.w = (u_xlatb0) ? u_xlat8 : 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat8 = u_xlat16_1.w * vs_COLOR0.w;
    u_xlat16_1.x = (u_xlatb4) ? 1.0 : 0.0;
    u_xlat16_9 = u_xlat16_0.x * _BaseColor.x + (-u_xlat16_5.x);
    u_xlat16_1.x = u_xlat16_1.x * u_xlat16_9 + u_xlat16_5.x;
#ifdef UNITY_ADRENO_ES3
    u_xlatb0 = !!(vs_COLOR0.y>=vs_COLOR0.z);
#else
...
SubProgram "gles " {
Local Keywords { "_COLORADDSUBDIFF_ON" "_FLIPBOOKBLENDING_ON" }
"#ifdef VERTEX
#version 100
...
void main()
{
    ...
    u_xlatu11 = uint(floatBitsToUint(u_xlat2.w)) >> 24u;
    u_xlat8.w = float(u_xlatu11);
    u_xlat8.yz = vec2(u_xlatu10.xy);
    ...
    u_xlat10.x = floor(u_xlat10.x);
    u_xlat20 = u_xlat10.x / unity_ParticleUVShiftData.y;
    u_xlat20 = floor(u_xlat20);
    u_xlat10.x = (-u_xlat20) * unity_ParticleUVShiftData.y + u_xlat10.x;
    u_xlat2.y = (-u_xlat20) * unity_ParticleUVShiftData.w + u_xlat0.x;
    u_xlat0.x = floor(u_xlat10.x);
    u_xlat2.x = u_xlat0.x * unity_ParticleUVShiftData.z;
    u_xlat1.xy = in_TEXCOORD0.xy * unity_ParticleUVShiftData.zw + u_xlat2.xy;
    u_xlat0.xy = in_TEXCOORD0.xy;
    u_xlat0.z = 0.0;
    vs_TEXCOORD5.xyz = (bool(u_xlatb30)) ? u_xlat1.xyz : u_xlat0.xyz;
    vs_TEXCOORD1.w = 0.0;
    vs_TEXCOORD1.xyz = u_xlat6.xyz;
    u_xlat0.xyz = (-u_xlat6.xyz) + _WorldSpaceCameraPos.xyz;
    u_xlat1.xyz = u_xlat4.yzx * u_xlat5.zxy;
    ...
    u_xlat16_9 = inversesqrt(u_xlat30);
    vs_TEXCOORD2.xyz = u_xlat1.xyz * vec3(u_xlat16_9);
    u_xlatb30 = unity_OrthoParams.w==0.0;
    u_xlat1.x = (u_xlatb30) ? u_xlat0.x : hlslcc_mtx4x4unity_MatrixV[0].z;
    u_xlat1.y = (u_xlatb30) ? u_xlat0.y : hlslcc_mtx4x4unity_MatrixV[1].z;
    u_xlat1.z = (u_xlatb30) ? u_xlat0.z : hlslcc_mtx4x4unity_MatrixV[2].z;
    u_xlat0.x = dot(u_xlat1.xyz, u_xlat1.xyz);
    u_xlat0.x = max(u_xlat0.x, 1.17549435e-38);
    u_xlat16_9 = inversesqrt(u_xlat0.x);
    vs_TEXCOORD3.xyz = u_xlat1.xyz * vec3(u_xlat16_9);
    vs_TEXCOORD8.xyz = vec3(0.0, 0.0, 0.0);
    vs_SV_InstanceID0 =  uint(gl_InstanceID);
    return;
}
